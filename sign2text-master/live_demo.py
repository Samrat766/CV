...
required_ap.add_argument("-m", "--model",
                         type=str, default="vgg16", required=False,
...
video_path="4629650-hd_1366_720_50fps.mp4"
